	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363343758405129@newsletter',
            newsletterName: 'NEXUS BOT 💫', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363343758405129@newsletter", "120363181579355112@newsletter", "120363218713824827@newsletter", "120363343758405129@newsletter", "120363343758405129@newsletter", "120363218713824827@newsletter"]
let canalNombre = ["NEXUS-𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⟡ APK-MODS 💫", "FREE -STREAMING  🐈", "Tips sobre GataBot 🤩", "𝗡𝗘𝗪 𝗣𝗥𝗢𝗝𝗘𝗖𝗧 ⟡ NEXUS-BOT-MD ✨", "Sky Ultra Plus ☁️", "🐈NEXUS-TEXT 💖✨"]
